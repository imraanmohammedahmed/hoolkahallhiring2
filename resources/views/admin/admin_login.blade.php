...
<head>
	...
	<title>Hoolka Admin Dashboard </title>
</head>
									...
									<div class="form-body">
                                        ...
                                        @csrf
											<div class="col-12">
												...
												<input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="imran@example.com">
												@error('login')

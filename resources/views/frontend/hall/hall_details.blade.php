                ...
                <div class="room-details-article">
                    ...
                    <div class="room-details-slider owl-carousel owl-theme">
                        ...
                        <div class="room-details-item">
                            <img src="{{ asset('upload/hallimg/multi_img/'.$image->multi_img) }}" alt="Images">
                        </div>
                        @endforeach
                    ...
                    <div class="room-details-title">
                        <h2>{{ $halldetails->type->name }}</h2>
                        <ul>
                            
                            <li>
                               <b> Basic : Ksh {{ $halldetails->price }}/Day</b>
                            </li> 
...
<div class="side-bar-list">
    <ul>
       <li>
            <a href="#"> <b>Capacity : </b> {{ $halldetails->hall_capacity }} Halls <i class='bx bxs-cloud-download'></i></a>
        </li>
        <li>
             <a href="#"> <b>Size : </b> {{ $halldetails->size }}ft2 <i class='bx bxs-cloud-download'></i></a>
        </li>
...
<div class="side-bar-list">
    <ul>
       <li>
            <a href="#"> <b>View : </b> {{ $halldetails->view }} <i class='bx bxs-cloud-download'></i></a>
        </li>
